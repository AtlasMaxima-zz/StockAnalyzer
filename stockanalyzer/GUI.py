...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        load = Image.open("/Users/LinPeng/PycharmProjects/StockPrediction/assets/startBackground.gif")
        ...
        # Start Button
        self.startImage = tk.PhotoImage(file="/Users/LinPeng/PycharmProjects/StockPrediction/assets/startButton.gif")
        button = tk.Button(self,image=self.startImage, command=lambda: controller.show_frame("PageOne"))
        button.place(x=140, y=300)

        # Close Button
        self.closeImage = tk.PhotoImage(file="/Users/LinPeng/PycharmProjects/StockPrediction/assets/closeButton.gif")
...
class PageOne(tk.Frame):
    def __init__(self, parent, controller):
        ...
        load = Image.open("/Users/LinPeng/PycharmProjects/StockPrediction/assets/background.gif")
        banner = ImageTk.PhotoImage(load)
        w = tk.Label(self, image=banner)
        w.image = banner
        w.place(x=0, y=0)
        ...
        # calculate button
        self.button_Image = tk.PhotoImage(file="/Users/LinPeng/PycharmProjects/StockPrediction/assets/calculateButton.gif")
...
class PageTwo(PageOne):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        load = Image.open("/Users/LinPeng/PycharmProjects/StockPrediction/assets/graphBanner.gif")
        banner = ImageTk.PhotoImage(load)
        w = tk.Label(self, image=banner)
        w.image = banner
        w.place(x=0, y=0)
